...
socket\t''
pipe\t''"
complete -c fd -s e -l extension -d 'Filter by extension' -r
...
complete -c fd -l ignore-parent -d 'Overrides --no-ignore-parent'
...
complete -c fd -l exact -d 'Match the entire filename exactly (literal, non-substring)'
