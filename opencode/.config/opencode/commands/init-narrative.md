---
description: Initialize a narrative writing task with AGENTS.md
agent: build
---

Initialize a work narrative writing task. Pre-fills `activity=writing`,
`doc_type=narrative`, and `task_type=work`, skipping three questions.
